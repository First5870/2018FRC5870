...
public class IO {
	...
	public Encoder leftEncode = new Encoder(0, 1, false, Encoder.EncodingType.k4X);
	public Encoder rightEncode = new Encoder(0, 1, true, Encoder.EncodingType.k4X);
	public I2C rioI2C = new I2C(I2C.Port.kMXP, 1);
